...
#define MV_PWMX_PIN     42                  // Maps to port 6 and pin 64 (A10) on Auriga
#define MV_PWMY_CHAN    LEDC_CHANNEL_5
#define MV_PWMY_PIN     41                  // Maps to port 6 and pin 69 (A15) on Auriga

// Flash / floodlights
#define MV_LED_PIN      2
#define MV_FLASH_PIN    1
#define MV_FLASH_CHAN   LEDC_CHANNEL_0
#define MV_FLASH_MAX    255

// I2C bus for display
#define MV_SDA_PIN      47
#define MV_SCL_PIN      21
